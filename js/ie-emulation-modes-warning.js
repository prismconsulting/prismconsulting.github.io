...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?v=2&amp;s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="6D81C35F:319E:11F86C6:5455867F" name="octolytics-dimension-request_id" />
...
<meta content="DGQt7/j+4rt6j0TvOE3JCrEUQtw/mbLmeYSh2N3VAduYfhJV2nMpcwQjXQQiWhWbrtJfuyr3MzMs3HYJxZKhxg==" name="csrf-token" />
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders" role="navigation" data-issue-count-url="/twbs/bootstrap/issues/counts" data-pjax-container-selector="#js-repo-pjax-container">
...
<a href="/twbs/bootstrap/blob/ab6f79c472bc306c82f85dea660e7c7351e3413e/docs/assets/js/ie-emulation-modes-warning.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/twbs/bootstrap/blob/center-modal-at-all-times/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="center-modal-at-all-times"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="center-modal-at-all-times">center-modal-at-all-times</a>
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/fix-modal-backdrop-above-scrollbar/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="fix-modal-backdrop-above-scrollbar"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="fix-modal-backdrop-above-scrollbar">fix-modal-backdrop-above-scrollbar</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/labels-readme/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="labels-readme"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="labels-readme">labels-readme</a>
            </div> <!-- /.select-menu-item -->
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/oh_arrow_where_art_thou/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="oh_arrow_where_art_thou"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="oh_arrow_where_art_thou">oh_arrow_where_art_thou</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02209s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
